...
class Auth:
    ...
    Attributes:
        ...
        ALGORITHM (str): Algorithm used for token encryption.
    ...
    async def create_access_token(self, data: dict, expires_delta: Optional[float] = None):
        ...
        Args:
            ...
            expires_delta (float, optional): Expiry duration for the token. Defaults to None.
    ...
    async def get_email_from_token(self, token: str):
        """
        Get the email from the email verification token.

        Args:
            token (str): Encoded email verification token.
